  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        <Text style={styles.subTitle}>Enter your credintial to continue</Text>
        ...
        <Text style={[styles.subTitle, { marginTop: 35, alignSelf: 'center' }]}>
          By continuing you agree to our {' '}<TouchableOpacity>
            <Text style={{ color: '#389f50ff', fontWeight: '600' }}>
              Terms or Service
            </Text>
          </TouchableOpacity>     <Text style={[styles.subTitle, { marginTop: 35, alignSelf: 'center' }]}>and</Text>  <TouchableOpacity>
            <Text style={{ color: '#389f50ff', fontWeight: '600' }}>
              Privacy or Policy
            </Text>
